...
#This is a self-contained program. You need to type in the patient's NRN, and the donor's name in the appropriate lines under "params" above. Then press the "Knit" button above. It will then create a PDF report.
```
...
#Connecting to the Patient table again, but this time to get the donor info out (donors are also stored in the Patient table in HisoTrac)
...
**UNOS unacceptable antigens:** `r Case$UnacceptAntigenTxt.recipient` 
